...
@CPF AS VARCHAR(12), @ANO AS INT = 2017, @NUM_NOTAS AS INT OUTPUT, @FATURAMENTO AS FLOAT OUTPUT
...
EXEC retornaValoresFaturamentoQuantidade @CPF='19290992743', @ANO=2017, -- VALOR
@NUM_NOTAS=@NUM_NOTAS OUTPUT, @FATURAMENTO=@FATURAMENTO OUTPUT -- REFERENCIA QUE SERÁ EXIBIDA